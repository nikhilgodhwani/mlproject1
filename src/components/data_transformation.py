...
import numpy as np
import pandas as pd
from sklearn.compose import ColumnTransformer ##used to create pipelines eg. hot encoding, standard scaling etc
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            ##combining numerical and categorical pipeline by using column transformer
